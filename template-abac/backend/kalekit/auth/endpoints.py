...
async def refresh(
    ...
    if token_row.expires_at < now:
        # This token's own fixed expiry lapsed without a refresh in
        # time. Not itself a sign of reuse/theft, so unlike the branches
        # above this doesn't revoke the family -- it's just an ordinary
        # "please log in again".
